...
.option("header", True) \
.schema(races_schema) \
.csv("/mnt/formula1dl9/dp203prep/races.csv")
...
races_selected_df.write.mode('overwrite').partitionBy('race_year').parquet('/mnt/formula1dl9/dp203processed/races')

# COMMAND ----------

display(spark.read.parquet("/mnt/formula1dl9//dp203processed/races"))

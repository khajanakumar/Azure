...
# MAGIC LOCATION '/mnt/formula1dl9/f1delta'

# COMMAND ----------

results_df = spark.read \
.option("inferSchema", True) \
.csv("/mnt/formula1dl9/prep/circuits.csv")

# COMMAND ----------

results_df.write.format("delta").mode("overwrite").saveAsTable("f1_delta.circuits_delta")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM f1_delta.circuits_delta;

# COMMAND ----------

results_df.write.format("delta").mode("overwrite").partitionby(race_year).save("/mnt/formula1dl/f1delta/results_external_delta")

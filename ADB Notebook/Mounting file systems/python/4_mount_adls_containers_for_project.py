...
mount_adls('formula1dl9', 'raw')

# COMMAND ----------

mount_adls('formula1dl9', 'processed')

# COMMAND ----------

mount_adls('formula1dl9', 'presentation')

# COMMAND ----------

mount_adls('formula1dl9', 'demo')

# COMMAND ----------

mount_adls('formula1dl9', 'dp203delta') 

# COMMAND ----------

mount_adls('formula1dl9', 'dp203prep')

# COMMAND ----------

mount_adls('formula1dl9', 'dp203processed')
